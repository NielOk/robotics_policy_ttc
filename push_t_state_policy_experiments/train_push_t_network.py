...
def train(noise_pred_net, noise_scheduler, dataloader, device="cuda", num_epochs=100):
    #@markdown ### **Training**
    #@markdown
...
if __name__ == '__main__':
    ...
    noise_pred_net, noise_scheduler, dataloader = prepare_network(obs_horizon, obs_dim, action_dim, num_diffusion_iters, dataset_path)

    num_epochs = 100
    train(noise_pred_net, noise_scheduler, dataloader, device="cuda", num_epochs=100)